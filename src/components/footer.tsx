...
const Footer: React.FC = () => {
  return (
     ...
     <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
        ...
        {linkSections.map((section) => (
            ...
            <div className=" flex flex-col w-full">
                <div className="inline-block py-2 px-3 text-white uppercase tracking-wide">Follow Us</div>
                <div className="flex pl-4 justify-center mt-2">
                    <Link className="block flex items-center text-gray-300 hover:text-white mr-6 no-underline" href="#">
                    ...
                    <Link className="block flex items-center text-gray-300 hover:text-white no-underline" href="#">
                        <svg viewBox="0 0 24 24" className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="pt-4 mt-4 border-t border-gray-800 text-center"> © 2019 Trusthold Group. All rights reserved.</div>
    </footer>
  );
};
